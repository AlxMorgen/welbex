    ...
    <div className="App">
      ...
      <main>
        <div className="container container-main">
          <div className="more-money">
            <div className="more-money_title">
              <h1>
                Зарабатывайте <br /> больше <br />{" "}
                <span className="color-title">с WELBEX</span>
              </h1>
            </div>
            <div className="more-money_disclaimer">
              <p>
          ...
          <div className="consultation">
            <div className="consultation-title">
              <h2>
                Вместе с <span className="color-title">БЕСПЛАТНОЙ <br />
            ...
            <div className="consultation-items">
              <div className="consultation-item">
                <div className="consultation-item-block">
                  <div className="consultation-item-block-title">
                    <h3>Виджеты</h3>
                  </div>
      ...
      <footer>
        <div className="container container-footer">
          ...
          <div className="footer-contacts">
            ...
            <div className="adress"><p>Москва, Путевой проезд 3с1, к 902</p></div>
          </div>
        </div>
      </footer>
      <div className="copyrights">
        ...
        <a className="confidencial" href="/">Политика конфиденциальности</a>
        </div>
